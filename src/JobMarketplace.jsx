  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#1a2035] font-sans text-gray-900 dark:text-white transition-colors duration-200">
      ...
      <div className="px-8 py-8">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-8 text-gray-900 dark:text-white">Job Openings for You</h1>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {recommendedJobs.map((job) => (
                <div key={job.id} className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-md flex flex-col justify-between transition-colors duration-200">
                  <div>
                  ...
                  <button className="mt-auto w-full py-2 bg-orange-500 rounded-lg hover:bg-orange-600 transition-colors duration-200 font-medium text-white">
                    Apply Now
                  </button>
                </div>
              ))}
