...
const CareerExploration = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#1a2035] font-sans text-gray-900 dark:text-white transition-colors duration-200">
      <Navbar />
      <div className="px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md relative transition-colors duration-200">
          ...
          <div className="lg:col-span-1 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md transition-colors duration-200">
          ...
          <div className="lg:col-span-1 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md transition-colors duration-200">
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-orange-500 rounded-lg hover:bg-orange-600 transition-colors duration-200 font-medium text-sm text-white"
                >
                  Explore Paths
                </button>
              </div>
            ...
            <button
              ...
              className="mt-6 w-full py-2 bg-orange-500 rounded-lg hover:bg-orange-600 transition-colors duration-200 font-medium text-white"
            >
              Expand More
            </button>
          </div>
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {detailedCareerCards.map((card) => (
              <div key={card.id} className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-md flex flex-col justify-between transition-colors duration-200">
                <div>
