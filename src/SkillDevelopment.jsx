  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#1a2035] font-sans text-gray-900 dark:text-white transition-colors duration-200">
      ...
      <div className="px-8 py-8">
        <h1 className="text-3xl sm:text-4xl font-bold mb-8 text-gray-900 dark:text-white">Skill Development Hub</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md transition-colors duration-200">
              ...
              {roadmapLevels.map((level, index) => (
                <React.Fragment key={level.id}>
                  ...
                  {index < roadmapLevels.length - 1 && (
                    <div className="absolute h-0.5 bg-gray-300 dark:bg-gray-600" style={{
            ...
            <button className="mt-6 w-full py-3 bg-orange-500 rounded-lg hover:bg-orange-600 transition-colors duration-200 font-medium text-white">
            ...
            <div className="space-y-4">
              {learningPathModules.map((module, index) => (
                <div key={module.id} className="flex items-center justify-between bg-orange-50 dark:bg-gray-700 p-4 rounded-lg transition-colors duration-200">
                  ...
                  {module.type === 'module' ? (
                    <button className="px-4 py-2 bg-orange-500 rounded-lg hover:bg-orange-600 transition-colors duration-200 text-sm font-medium text-white">
                      Start Module
                    </button>
                  ) : (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          {/* Overall Tracking */}
          <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md flex flex-col items-center justify-center transition-colors duration-200">
