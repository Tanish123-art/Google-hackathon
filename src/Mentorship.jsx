  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#1a2035] font-sans text-gray-900 dark:text-white transition-colors duration-200">
      ...
      <div className="px-8 py-8">
        <h1 className="text-3xl sm:text-4xl font-bold mb-8 text-gray-900 dark:text-white">Mentorship and Community Engagement</h1>
        ...
        <div className="mt-8 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md transition-colors duration-200">
